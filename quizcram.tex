...
\begin{enumerate}
\item Extra free-response questions (as described in the Materials section)
\item Original in-video questions from Coursera
\item Original unit exam from Coursera
\item Extra multiple-checkbox questions (as described in the Materials section)
\end{enumerate}

Parts 2-4 of the exam were automatically graded, giving each question a score equal to the fraction of checkboxes correctly checked. The free-response questions, which were all of the general form ``State N facts about X'', were graded by marking each fact stated by students as correct or incorrect, then giving them a score of (number of correct facts written) / Max(number of facts requested by question, number of facts written). Thus, for a question requesting 2 facts, giving 1 correct fact gets a score of 1/2, giving 2 correct facts and 1 incorrect fact gets a score of 2/3, etc.
