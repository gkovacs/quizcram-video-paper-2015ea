...
Our second study was an within-subjects study that compared the QuizCram format with double the number of original questions (resulting from inserting additional questions into the video), to an in-video quiz interface with the original questions from Coursera. We wished to answer the questions:

\begin{itemize}
\item \textbf{Q1:} Do users using QuizCram better remember answers to the original in-video questions?
\item \textbf{Q2:} Do users using QuizCram perform better on the unit quiz?
\item \textbf{Q3:} Can we improve recall of particular facts from the video by inserting additional questions with QuizCram?
\item \textbf{Q4:} Do users enjoy using QuizCram?
\item \textbf{Q5:} How do users use QuizCram?
...
Users were better able to answer the original in-video questions when using QuizCram. They averaged 85.4\% correctness with QuizCram, compared to 81.3\% correctness with the in-video quiz format. A t-test showed this difference was statistically significant (t=2.24, p=0.0391). The average scores between the two halves were similar -- 84.5\% average for part 1, 82.2\% average for part 2, with no significant difference (t=0.55, p=0.589). Thus, even though the users encountered the original in-video questions in both conditions, the QuizCram format caused them to remember the answers better.
...
Although the users who used QuizCram had never seen the free-response questions before, the questions asked similar material to the extra multiple-checkbox questions we had inserted for the QuizCram format, except in free-response format. 



Users performed slightly better . The second part of the unit exam appeared to be easier than the first half -- the mean was 59\% for the first half, vs 69\% for the second half -- however, this difference was not statistically significant ().



Thus, even though the users encountered the original in-video questions in both conditions, the QuizCram format caused them to remember the answers better.
