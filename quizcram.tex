...
On day 1, users studied the first section (5 videos with a total length of 23 minutes) with one tool for 40 minutes, and answered a survey about the tool. Then, they studied the second section (5 videos with a total length of 25 minutes) with the other tool for 40 minutes, and answered a survey about the tool. The order of tools was randomized. % Our server logged interactions with each of the tools.
